...
let carModels = inventory.sort(function(a, b) {
    if(a.car_make < b.car_make) {return -1}
    if(a.car_make > b.car_make) {return 1}
    return 0
});
...
let carYears = carModels.map(function(d){
    return d.car_year;
})
...
let oldCars = carYears.filter(function(i){
    return i > 2000;
});
...
let BMWAndAudi = inventory.filter(function(make){
    a = make.car_make == 'Audi';
    b = make.car_make == 'BMW';
    return a + b;
});
